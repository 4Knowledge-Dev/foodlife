...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class AndroidxAppLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>appStartUp</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getStartup() {
            return create("androidx.app.startup");
        }
    ...
    public static class AndroidxComposeLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>font</b> with <b>androidx.compose.ui:ui-text-google-fonts</b> coordinates and
         * with version reference <b>composeFont</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
    ...
    public static class AndroidxCredentialsLibraryAccessors extends SubDependencyFactory {
        ...
        public Provider<MinimalExternalModuleDependency> getManager() {
            return create("androidx.credentials.manager");
        }
    ...
    public static class AndroidxMedia3LibraryAccessors extends SubDependencyFactory {
        ...
        public Provider<MinimalExternalModuleDependency> getDash() {
            return create("androidx.media3.dash");
        }
        ...
        public Provider<MinimalExternalModuleDependency> getPlayer() {
            return create("androidx.media3.player");
        }
    ...
    public static class AndroidxNavigationLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>component</b> with <b>androidx.navigation:navigation-compose</b> coordinates and
         * with version reference <b>androidxNavigation</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getComponent() {
            return create("androidx.navigation.component");
        }
    ...
    public static class IdentityLibraryAccessors extends SubDependencyFactory {
        ...
        public Provider<MinimalExternalModuleDependency> getGoogleid() {
            return create("identity.googleid");
        }
    ...
    public static class KotlinxLibraryAccessors extends SubDependencyFactory {
        ...
        public Provider<MinimalExternalModuleDependency> getCoroutine() {
            return create("kotlinx.coroutine");
        }
    ...
    public static class PlayLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>playService</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getServices() {
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>appStartUp</b> with value <b>1.2.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getAppStartUp() { return getVersion("appStartUp"); }
        ...
        /**
         * Version alias <b>composeFont</b> with value <b>1.7.8</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getComposeFont() { return getVersion("composeFont"); }
        ...
        /**
         * Version alias <b>facebook</b> with value <b>18.0.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>playService</b> with value <b>21.3.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getPlayService() { return getVersion("playService"); }
